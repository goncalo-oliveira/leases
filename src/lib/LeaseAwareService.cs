...
/// <summary>
/// Base class for services that are aware of distributed leases.
/// </summary>
/// <param name="leaseStore">The lease store used to acquire, renew, and release leases.</param>
public abstract class LeaseAwareService( IDistributedLeaseStore leaseStore ) : BackgroundService
{
    /// <summary>
    ...
    internal async Task<DistributedLease?> TryAcquireLeaseAsync( CancellationToken cancellationToken )
    {
