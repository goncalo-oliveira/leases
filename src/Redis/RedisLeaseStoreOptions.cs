...
public sealed class RedisLeaseStoreOptions
{
    ...
    /// The default value is "service-leases", which means that all lease keys will be prefixed with "service-leases:" followed by the lease name.
    ...
    /// </summary>
    public string KeyPrefix { get; set; } = "service-leases";
}
